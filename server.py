...
class ServerScsyncProtocol(BaseScsyncProtocol):
    ...
    def __init__(self, loop, path, packets_per_second, chunk_size, test, users):
...
def run(args):
    ...
    listen = loop.create_datagram_endpoint(
        lambda: ServerScsyncProtocol(loop, args.path, args.cc, args.chunk_size, args.test, users),
